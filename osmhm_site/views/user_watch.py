...
@view_config(
    ...
    renderer="osmhm_site:templates/user_watch.mako",
...
def user_watch(request):
    try:
        ...
        history = (
            DBSession.query(History_Users, Watched_Users)
            .filter(Watched_Users.authorid == userid)
            .join(Watched_Users, History_Users.wid == Watched_Users.id)
            .order_by(desc(History_Users.changeset))
            .all()
        )
...
@view_config(
    ...
    renderer="osmhm_site:templates/user_watch_list.mako",
    permission="watch_user_or_object",
)
...
@view_config(
    ...
    renderer="osmhm_site:templates/user_watch_list_add.mako",
